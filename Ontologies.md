...
<h3>Version 2.0</h3> integrates the food product taxonomy from <a href="foodon.org/">FoodOn</a>, seperates food ingredients in recipes (coming soon) from non-food ingredients in non-food products, integrates an extensive food product nutrition ontology that uses FoodOn classification and <a href="https://fdc.nal.usda.gov/fdc-app.html#/">FDC data</a> and adds a user profile ontology to be used in various applications.<br>
